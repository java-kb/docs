---
title: Memento(refactoring.guru)
parent: Memento
nav_order: 1
---
...
![Memento design pattern](image.png)
...
![Reverting operations in the editor](image-1.png)
...
![How to make a copy of the object's private state?](image-2.png)
...
![The originator has full access to the memento, whereas the caretaker can only access the metadata](image-3.png)
...
![Memento based on nested classes](memento-structure.png)
...
![Memento without nested classes](image-5.png)
...
![Memento with strict encapsulation](image-6.png)
...
![Structure of the Memento example](image-7.png)
