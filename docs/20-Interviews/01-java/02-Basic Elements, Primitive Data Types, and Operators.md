...
1. **Which of the following is not a legal comment in Java?Select the one correct answer.**{: .label-red }
...
2. **What will be the result of compiling and running the following program?**{: .label-red }
...
3. **What will be the result of compiling and running the following program?**{: .label-red }
   ```java
   ...
   ```
    ...
    > string denoted by c—that is, "cat".

4. **Which of the following expressions evaluate to a floating-point value?**{: .label-red }
...
5. **What is the value of the expression (1 / 2 + 3 / 2 + 0.1)?**{: .label-red }
    Select the one correct answer.
...
1. **What is the value of evaluating the following expression: (- -1-3 * 10 / 5-1)?**{: .label-red }
    Select the one correct answer.
...
2. **What is the result of compiling and running the following program?**{: .label-red }
   ```java
    public class Prog1 {
    public static void main(String[] args) {
    int k = 1;
...
3. **Which is the first line that will cause a compile-time error in the following program?**{: .label-red }
    ```java
    public class MyClass {
    public static void main(String[] args) {
    char c;
...
1. **What will be the result of compiling and running the following program?**{: .label-red }
    ```java
...
1. **Which of the following statements are true?**{: .label-red }
...
1. **Which of the following statements are true about the lines of output printed by the following program?**{: .label-red }
    ```java
    public class BoolOp {
...
1. **What is the result of running the following program?**{: .label-red }
   ```java
   ...
   ```
    ...
    > (b) 
    > 
    > The element referenced by a[i] is determined based on the current value of i,which is 0—that is, the element a[0]. The expression i = 9 will evaluate to the value 9, which will be assigned to the variable i. The value 9 is also assigned to the array element a[0]. After execution of the statement, the variable i will contain the value 9, and the array a will contain the values 9 and 6. The program will print 996 when run.

1. **Which of the following statements are true about the output from the following program?**{: .label-red }
   ```java
    public class Logic {
    public static void main(String[] args) {
    int i = 0;
...
1. **Which of the following statements when inserted at (1) will not result in a compile-time error?**{: .label-red }
   ```java
...
1. **Which of the following statements are true about the following code?**{: .label-red }
   ```java
